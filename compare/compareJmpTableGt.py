...
def readJmpTablesCompared(mModule, binary):
    """
    read jump tables from protobufs
    params:
        mModule: protobuf module
    ...
    for func in mModule.fuc:
        ...
        for bb in func.bb:
            ...
            if not checkTerminatorIsIndirectJump(MD, disassemble_content, terminator_addr):
                continue
...
if __name__ == '__main__':
    ...
    (comparedTables, insts) = readJmpTablesCompared(mModule2, options.binaryFile)
