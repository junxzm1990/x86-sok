...
FUNCBOUND_PATH=checkpoints/instbound_elfmap
...
CUDA_VISIBLE_DEVICES=0 python train.py data-bin/instbound_elfmap \
    --max-positions 512 \
    ...
    --restore-file $FUNCBOUND_PATH/checkpoint_best.pt | tee result/instbound_elfmap
